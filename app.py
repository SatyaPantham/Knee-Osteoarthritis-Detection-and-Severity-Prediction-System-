...
icon = Image.open("img/KARE.png")
st.set_page_config(
    page_title="Knee Osteoarthritis Detection and Severity Prediction System",
    page_icon=icon,
)
...
with st.sidebar:
    st.image(icon)
    st.subheader("CSP PROJECT ")
    st.caption("Developers :- P.Satya , Rahul Sharma , K.Mahesh , Md.Mazid")
...
# Body
st.header("Knee Osteoarthritis Detection and Severity Prediction System")
